...
bool responsiveVisibility({
  ...
  // log(name: "responsiveVisibility", width.toString());
  if (width < kBreakpointSmall) {
    // log(name: "TIPO DE DISPOSITIVO", "PHONE");
    return phone;
  } else if (width < kBreakpointMedium) {
    // log(name: "TIPO DE DISPOSITIVO", "TABLET");
    return tablet;
  } else if (width < kBreakpointLarge) {
    // log(name: "TIPO DE DISPOSITIVO", "TABLET LANDSCAPE");
    return tabletLandscape;
  } else {
    // log(name: "TIPO DE DISPOSITIVO", "DESKTOP");
    return desktop;
  }
}
